	...
	<div class="mx-auto py-12 px-8 sm:px-6 lg:flex lg:items-center lg:py-16 lg:px-12">
		<div class="text-center lg:w-0 lg:flex-auto">
			...
			<p class="mt-3 text-lg text-gray-300">
				...
				Дзержинске. Широкий ассортимент и доступные цены приятно вас удивят. При необходимости вы
				можете приобрести стройматериалы с доставкой до вашего объекта.
			</p>
		</div>
	</div>
</div>
			...
			<div class="mt-8 lg:mt-0">
				<div class="mx-auto max-w-prose text-base lg:max-w-none">
					...
					>
						...
						самовывоза. У нас всегда действую акции и Вы сможете строительные материалы купить со
