			...
			<div class="mt-8 lg:mt-0">
				<div class="mx-auto max-w-prose text-base lg:max-w-none">
					...
					>
						...
						продавцами! Клиенты приобретают стройматериалы с доставкой до объекта или на условиях
						самовывоза. У нас всегда действую акции и Вы сможете купить стройматериалы в Дзержинске со
						скидкой или с отсрочкой платежа.
					</p>
				</div>
				<div
					class="prose prose-cyan mx-auto mt-1 text-gray-500 lg:col-start-1 lg:row-start-1 lg:max-w-none"
				>
					...
					<p>Вы всегда можете купить стройматериалы в Дзержинске через каталог или на нашей стройбазе.</p>
				</div>
			</div>
		</div>
	</div>
