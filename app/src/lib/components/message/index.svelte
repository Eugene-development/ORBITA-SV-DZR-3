			...
			<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:h-full lg:p-0">
				...
				>
					<img
						...
						alt="Стройматериалы в Дзержинске"
					/>
				</div>
			</div>
		</div>
				...
				<blockquote>
					<div>
						...
						<p class="text-blueGray-800 mt-6 text-xl font-medium">
							Самая крупная база стройматериалов в Дзержинске "Орбита-Строй" предлагает в сезоне
							2025 года наилучшие предложения по ассортименту и ценам на строительные и отделочные
							материалы, а так же на напольные покрытия и метизную продукцию. Находится наш
							строительный интернет магазин на выезде из Дзержинска недалеко от Нижнего Новгорода.
							Если вас интересуют стройматериалы в Дзержинске или в Нижнем Новгороде, то мы ждём Вас
							на нашей базе!
						</p>
					</div>
					<footer class="mt-6">
