			...
			<blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
				<div class="relative text-lg font-medium text-white md:flex-grow">
					...
					<p class="relative">
						...
						строительных материалов на объекты нашего предприятия. Мы зачастую делаем заявки и через
						интернет магазин стройматериалов этой компании.
					</p>
				</div>
				<footer class="mt-8">
					<div class="flex">
			...
			<blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
				<div class="relative text-lg font-medium text-white md:flex-grow">
					...
					<p class="relative">
						...
						взаимовыгодное сотрудничество с Вами и вашим коллективом. Рады, что теперь есть удобный
