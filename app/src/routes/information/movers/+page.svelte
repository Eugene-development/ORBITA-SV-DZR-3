...
<div
	class="relative mx-auto mt-16 grid w-full max-w-container grid-cols-1 px-4 sm:mt-20 sm:px-6 lg:px-8 xl:mt-32"
>
	<div
		class="col-start-1 row-start-1 h-7 text-base font-semibold leading-7 text-sky-500"
		aria-hidden="true"
	>
		By the makers of Tailwind CSS
	</div>
	<h1
		class="col-start-1 row-start-2 mt-4 max-w-[36rem] text-4xl font-extrabold tracking-tight text-slate-900 sm:text-7xl xl:max-w-[43.5rem]"
	>
		Build your next idea even faster.
	</h1>
	<p class="col-start-1 row-start-3 mt-4 max-w-lg text-lg text-slate-700">
		Beautifully designed, expertly crafted components and templates, built by the makers of Tailwind
		CSS. The perfect starting point for your next project.
	</p>
	<div
	...
	>
		<a
			...
			><span
				>Browse components<!-- -->
				<span aria-hidden="true" class="hidden text-slate-400 sm:inline">→</span></span
			></a
		><a
			...
			><span
				>Explore templates<!-- -->
				<span aria-hidden="true" class="hidden text-black/25 sm:inline">→</span></span
			></a
		>
	</div>
	<div
	...
	>
		<div
			class="-ml-[32rem] mt-12 h-[46.375rem] origin-top scale-[calc(204/299)] select-none sm:-ml-[24rem] sm:-mt-20 sm:h-auto sm:transform-none md:-ml-64 md:mt-10 lg:-ml-16 lg:mt-0 xl:-mr-4 xl:ml-0"
		>
			<div class="flex justify-end">
				<div class="relative flex items-end">
					<div
						class="absolute -inset-x-8 bottom-0 h-px bg-slate-900/15 [mask-image:linear-gradient(to_right,transparent,white_4rem,white_calc(100%-4rem),transparent)]"
					/>
					<div class="absolute left-16 top-full -mt-px h-8 overflow-hidden">
					...
					<div>
						<div class="p-4">
							<div
								class="ml-auto pointer-events-auto h-6 w-10 rounded-full p-1 ring-1 ring-inset transition duration-200 ease-in-out bg-indigo-600 ring-black/20"
							>
								<div
						...
						<div class="relative z-10 p-4 text-right">
							...
							/>
							<div
								class="absolute inset-0 -right-px bg-gradient-to-br from-white/0 via-white/25 to-white/0"
							/>
							<div
							...
							>
								<div class="flex px-3 py-2">
									<svg class="mr-2.5 h-5 w-5 flex-none fill-slate-400"
										><path d="M5 4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v14l-5-2.5L5 18V4Z" /></svg
									>Bookmark
								</div>
					...
					<div class="relative z-10 p-4">
						...
						<div
							class="absolute -inset-x-8 top-0 h-px bg-slate-900/15 [mask-image:linear-gradient(to_left,transparent,white_4rem,white_calc(100%-4rem),transparent)]"
						/>
						<div class="absolute bottom-full left-40 -mb-px flex h-8 items-end overflow-hidden">
						...
						>
							...
							<div class="flex items-center p-4">
								<img src="/img/avatar-2.jpg" alt="" class="h-10 w-10 flex-none rounded-full" />
								<div class="ml-4 flex-auto">
							...
							<div class="flex items-center p-4">
								<img src="/img/avatar-3.jpg" alt="" class="h-10 w-10 flex-none rounded-full" />
								<div class="ml-4 flex-auto">
							...
							<div class="p-4">
								<div
									class="pointer-events-auto rounded-md px-4 py-2 text-center font-medium shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50"
								>
									View all
								</div>
							</div>
			...
			<div class="flex justify-end">
				<div class="relative z-10 p-4">
					<div
						class="flex w-[41rem] rounded-lg bg-white shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
					>
						<div class="flex items-center space-x-4 px-6 py-4">
							...
							><svg class="h-10 w-10 flex-none" fill="none"
								><circle cx="20" cy="20" r="20" fill="#0F172A" /><path
									fill-rule="evenodd"
									clip-rule="evenodd"
			...
			<div class="flex items-start justify-end">
				<div>
					<div class="relative flex items-end justify-end">
						...
						<div>
							<div class="flex justify-end p-4">
								<div
									class="pointer-events-auto flex divide-x divide-slate-400/20 overflow-hidden rounded-md bg-white text-[0.8125rem] font-medium leading-5 text-slate-700 shadow-sm ring-1 ring-slate-700/10"
								>
									<div class="px-4 py-2 hover:bg-slate-50 hover:text-slate-900">Years</div>
									<div class="px-4 py-2 hover:bg-slate-50 hover:text-slate-900">Months</div>
									<div class="px-4 py-2 hover:bg-slate-50 hover:text-slate-900">Days</div>
								</div>
							</div>
							<div class="relative z-10 p-4">
								<div
								...
								<div
									class="absolute -inset-y-8 right-0 w-px bg-slate-900/15 [mask-image:linear-gradient(to_top,transparent,white_4rem,white_calc(100%-4rem),transparent)]"
								/>
								<div class="absolute bottom-full left-16 -mb-px flex h-8 items-end overflow-hidden">
									<div class="flex -mb-px h-[2px] w-56">
										<div
											class="w-full flex-none blur-sm [background-image:linear-gradient(90deg,rgba(56,189,248,0)_0%,#0EA5E9_32.29%,rgba(236,72,153,0.3)_67.19%,rgba(236,72,153,0)_100%)]"
										/>
								...
								<div
									class="flex w-[23.5625rem] items-center rounded-md bg-white p-4 shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
								>
									<svg
										class="h-6 w-6 flex-none stroke-slate-500"
										stroke-width="2"
										stroke-linecap="round"
										fill="none"><path d="M4 7h16M4 12h16M4 17h16" /></svg
									...
									>
									<div
										class="ml-auto flex h-6 w-6 items-center justify-center rounded-md shadow ring-1 ring-slate-900/10"
									>
									...
									<div class="ml-6 text-[0.8125rem] font-medium text-slate-700">v3.0</div>
									<svg class="ml-2 h-1 w-1.5 overflow-visible fill-slate-400 stroke-slate-400"
										><path d="M0 0H6L3 4Z" stroke-width="1" stroke-linejoin="round" /></svg
									><svg viewBox="0 0 16 16" class="ml-6 h-6 w-6 fill-slate-400"
										><path
						...
						<div class="relative z-10 p-4">
							<div class="space-y-4">
								<div
									class="pointer-events-auto w-[21rem] rounded-lg bg-white p-4 text-[0.8125rem] leading-5 shadow-xl shadow-black/5 hover:bg-slate-50 ring-2 ring-indigo-600"
								>
								...
								<div
									class="pointer-events-auto w-[21rem] rounded-lg bg-white p-4 text-[0.8125rem] leading-5 shadow-xl shadow-black/5 hover:bg-slate-50 ring-1 ring-slate-700/10"
								>
									<div class="flex justify-between">
					...
					<div class="flex items-start justify-end">
						<div class="relative p-4">
							...
							/>
							<div
								class="pointer-events-auto w-36 space-y-1 rounded-lg bg-white p-3 text-[0.8125rem] font-medium leading-6 text-slate-700 shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
							>
								<div class="flex rounded-[10px] p-1 bg-slate-50">
									<div
										class="flex h-6 w-6 flex-none items-center justify-center rounded-md bg-white shadow ring-1 ring-slate-900/10"
									>
									...
									<div class="ml-3 text-slate-900">Light</div>
								</div>
						...
						<div class="relative p-4">
							...
							<div
								class="pointer-events-auto w-[28.125rem] text-[0.8125rem] leading-5 text-slate-700"
							>
								<div class="font-semibold text-slate-900">Assigned to</div>
								<div
									class="mt-2 flex items-center justify-between rounded-md bg-white px-3 py-2 shadow-sm ring-1 ring-slate-700/10"
								>
									Tom Cook<svg class="h-5 w-5 flex-none fill-slate-400"
										><path
								...
								<div
									class="mt-4 overflow-hidden rounded-md bg-white py-1 shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
								>
									<div class="px-3 py-2 bg-indigo-600 text-white">Wade Cooper</div>
									<div class="px-3 py-2">Arlene Mccoy</div>
									<div class="px-3 py-2">Tom Cook</div>
									<div class="px-3 py-2">Devon Webb</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div>
					<div class="relative p-4">
						<div
							class="pointer-events-auto w-[25.625rem] rounded-lg bg-white text-[0.8125rem] leading-5 text-slate-700 shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
						>
							...
							<div class="border-t border-slate-400/20 px-3.5 py-3">
								...
								<div class="flex items-center rounded-md p-1.5">
									<svg
										...
										stroke-width="2"
										stroke-linecap="round"
										stroke-linejoin="round"><path d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" /></svg
									>Add hashtag...
								</div>
								<div class="flex items-center rounded-md p-1.5">
									<svg
					...
					<div class="relative p-4">
						<div
							class="-mr-[4.625rem] w-[30.25rem] rounded-md bg-white p-4 text-[0.8125rem] leading-6 text-slate-900 shadow-xl shadow-black/5 ring-1 ring-slate-700/10"
						>
							<div class="font-semibold leading-5">Account</div>
							<div class="mt-2 leading-5 text-slate-500">
								Manage how information is displayed on your account.
							</div>
							<div class="mt-4 flex items-center border-t border-slate-400/20 py-3">
								<span class="w-2/5 flex-none">Language</span><span class="">English</span><span
									class="pointer-events-auto ml-auto font-medium text-indigo-600 hover:text-indigo-500"
									>Update</span
								>
							</div>
							<div class="flex items-center border-t border-slate-400/20 py-3">
								<span class="w-2/5 flex-none">Date format</span><span class="">DD-MM-YYYY</span
								><span class="ml-auto flex items-center font-medium text-indigo-600"
									><span class="pointer-events-auto hover:text-indigo-500">Update</span><span
										class="mx-3 h-6 w-px bg-slate-400/20"
									/><span class="pointer-events-auto hover:text-indigo-500">Remove</span></span
								>
							</div>
							<div class="flex items-center border-t border-slate-400/20 py-3">
