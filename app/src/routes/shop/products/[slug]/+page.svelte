				...
				<div  class="flex items-center space-x-4 mx-auto">
					...
					<div>
						<div class="flex items-center">
							...
							<a  data-sveltekit-prefetch
								...
								href="/shop/rubric/{data.category.category_one.parent.parent.slug}" class="ml-4 text-xl font-medium text-slate-600 ">{data.category.category_one.parent.parent.value}</a>
						</div>
					</div>
					...
					<div>
						<div class="flex items-center">
							...
							<a  data-sveltekit-prefetch
							    data-sveltekit-noscroll
								href="/shop/category/{data.category.category_one.parent.slug}" class="ml-4 text-xl font-medium text-slate-600 ">{data.category.category_one.parent.value}</a>
						</div>
					</div>
