...
<svelte:head>
	<title>"Орбита-строй" | Распродажа стройматериалов</title>
	<meta
		name="description"
		content="Распродажа строительных и отделочных материалов по специальным ценам"
	/>
</svelte:head>
	...
	<div class="px-6 lg:px-0">
		<div class="sm:flex sm:items-center">
			<div class="sm:flex-auto">
				<h1 class="text-4xl font-semibold text-gray-900">Распродажа</h1>
				<p class="mt-2 text-base text-gray-700">
					Условия отгрузок и размер остатков уточняйте у наших менеджеров
				</p>
			</div>
		</div>
