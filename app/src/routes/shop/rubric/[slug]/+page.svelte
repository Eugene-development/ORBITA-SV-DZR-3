...
<div class="py-8">
	<div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
		<div class="mx-auto max-w-3xl space-y-2 lg:max-w-none">
				...
				<div  class="flex items-center space-x-4 mx-auto">
					...
					<div>
						<div class="flex items-center">
							...
							<span class="ml-4 text-base font-medium text-gray-600 ">{data.catalog.catalog_one.value}</span>
						</div>
					</div>
			...
			<p class="text-xl text-slate-800">Выберите интересующую вас рубрику в этом разделе. Наличие уточняйте у менеджеров по указанным телефонам. Если вы купите продукцию через сайт, то для вас будет дополнительная скидка 5%</p>
		</div>
	</div>
</div>
