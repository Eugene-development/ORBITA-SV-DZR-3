...
<section class="py-12">
	...
	>
		<div class="mr-auto place-self-center lg:col-span-7">
			...
			<p
				class="max-w-3xl mb-6 font-light text-gray-500 lg:my-8 md:text-lg lg:text-xl dark:text-gray-400"
			>
